...
import ru.azerusteam.api.noteblock.*;
...
public abstract class SongPlayer {
    ...
    protected ru.azerusteam.api.noteblock.model.songplayer.Fade fadeIn;
    protected ru.azerusteam.api.noteblock.model.songplayer.Fade fadeOut;
    protected ru.azerusteam.api.noteblock.model.songplayer.Fade fadeTemp = null;
    ...
    public SongPlayer(Playlist playlist, SoundCategory soundCategory, boolean random){
        ...
        fadeIn = new ru.azerusteam.api.noteblock.model.songplayer.Fade(FadeType.NONE, 60);
        fadeIn.setFadeStart((byte) 0);
        fadeIn.setFadeTarget(volume);

        fadeOut = new ru.azerusteam.api.noteblock.model.songplayer.Fade(FadeType.NONE, 60);
    ...
    private void start() {
        ...
        }).delay(0L, TimeUnit.TICK).schedule();
    }
     ...
     * @return Fade
     */
    public ru.azerusteam.api.noteblock.model.songplayer.Fade getFadeIn(){
        return fadeIn;
    }
     ...
     * @return Fade
     */
    public ru.azerusteam.api.noteblock.model.songplayer.Fade getFadeOut(){
        return fadeOut;
    }
